<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='jianguanuyuan'"  label='监管员姓名' prop="jianguanuyuanName">
               <el-input v-model="ruleForm.jianguanuyuanName"  placeholder='监管员姓名' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='jianguanuyuan'" label='头像' prop="jianguanuyuanPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='jianguanuyuan'"  label='联系方式' prop="jianguanuyuanPhone">
               <el-input v-model="ruleForm.jianguanuyuanPhone"  placeholder='联系方式' clearable></el-input>
           </el-form-item>
         </el-col>
...
// 注册表 监管员 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         if((!this.ruleForm.jianguanuyuanName)&& 'jianguanuyuan'==this.flag){
                             this.$message.error('监管员姓名不能为空');
                             return
                         }

                         if((!this.ruleForm.jianguanuyuanPhoto)&& 'jianguanuyuan'==this.flag){
                             this.$message.error('头像不能为空');
                             return
                         }

                         if((!this.ruleForm.jianguanuyuanPhone)&& 'jianguanuyuan'==this.flag){
