<template>
    <div style="backgroundImage: url('/p2pjiedaiwangzhan/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">P2P借贷网站注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="监管员姓名" class="input" v-if="tableName=='jianguanuyuan'">
                            <el-input v-model="ruleForm.jianguanuyuanName" autocomplete="off" placeholder="监管员姓名"  />
                        </el-form-item>
                        <el-form-item label="联系方式" class="input" v-if="tableName=='jianguanuyuan'">
                            <el-input v-model="ruleForm.jianguanuyuanPhone" autocomplete="off" placeholder="联系方式"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.jianguanuyuanName)&& 'jianguanuyuan'==this.tableName){
                                this.$message.error('监管员姓名不能为空');
                                return
                            }
                             if('jianguanuyuan' == this.tableName && this.ruleForm.jianguanuyuanPhone&&(!this.$validate.isMobile(this.ruleForm.jianguanuyuanPhone))){
