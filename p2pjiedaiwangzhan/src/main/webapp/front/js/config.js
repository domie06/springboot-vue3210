...
var centerMenu = [
    ...
    ,{
        name: '贷款申请',
        url: '../daikuanchanpinOrder/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '贷款产品',
        url: './pages/daikuanchanpin/list.html'
    },
    {
        name: '论坛',
...
var adminurl =  "http://localhost:8080/p2pjiedaiwangzhan/admin/dist/index.html#/login";
